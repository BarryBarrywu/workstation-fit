...
const evidenceLinksEnabled = import.meta.env.PUBLIC_SITE_EDITION !== 'toy';
...
export const evidenceChains: Record<EvidenceKey, EvidenceChain> = {
  seat: {
    id: 'seat',
    label: '椅面高度',
    summary: '先根据中国成人的坐姿腘高估算，再按脚掌和膝盖的位置调整。',
    population: '中国 18–70 岁成人，包含男性和女性。数据来自静态人体测量。',
    sourceCoverage: { minHeight: 143, maxHeight: 186 },
    adoptedData: '身高/坐姿腘高节点（cm）：143/34.1、158/38.0、168.7/41.3、186/46.9；由女性与男性百分位节点组成。',
    transformation: '在相邻来源节点之间按身高做线性插值，得到中心值后，上下各保留 2 cm 作为参考范围。',
    extrapolation: '身高超过 186 cm 后，每增加 1 cm，项目将中心值向上估算 0.216 cm。该结果来自项目估算，不是国家标准给出的个人回归公式。',
    limitations: '只看身高，无法准确判断个人腿长，百分位配对也不能代替个人回归。鞋底厚度、坐垫压缩、腿部比例和脚踏都会影响实际椅面高度。',
    sources: [gbStandard, cnisSurvey, cornellChair],
  },
  sittingDesk: {
    id: 'sittingDesk',
    label: '坐姿桌面高度',
    summary: '结合椅面高度与坐姿肘高，让肩膀放松时，前臂能自然靠近桌面。',
    population: '中国 18–70 岁成人的人体尺寸，适用于普通键盘和鼠标办公。',
    sourceCoverage: { minHeight: 143, maxHeight: 186 },
    adoptedData: '由坐姿腘高与坐姿肘高合成的身高/桌面中心节点（cm）：143/55、158/63、168.7/68、186/76。',
    transformation: '将椅面中心值与坐姿肘高合并，再按身高做线性插值。中心值上下各保留 2 cm 作为参考范围。',
    extrapolation: '身高超过 186 cm 后，每增加 1 cm，项目将中心值向上估算 0.46 cm。该结果来自项目估算。',
    limitations: '百分位配对不能代替个人回归。键盘厚度、扶手、前臂长度、坐垫压缩和工作内容都会影响实际桌面高度。',
    sources: [gbStandard, cnisSurvey, mayoOffice],
  },
  standingDesk: {
    id: 'standingDesk',
    label: '站姿桌面高度',
    summary: '以站姿肘高为中心，让肩膀保持放松，手腕与前臂自然成一条线。',
    population: '中国 18–70 岁成人的人体尺寸，适用于普通键盘和鼠标办公。',
    sourceCoverage: { minHeight: 143, maxHeight: 186 },
    adoptedData: '身高/立姿肘高节点（cm）：143/86、158/96、168.7/103.7、186/116.1。',
    transformation: '按身高对立姿肘高做线性插值，中心值上下各保留 2 cm 作为参考范围。',
    extrapolation: '身高超过 186 cm 后，每增加 1 cm，项目将中心值向上估算 0.62 cm。该结果来自项目估算。',
    limitations: '百分位配对不能代替个人回归。鞋底厚度、键盘厚度、前臂比例和工作内容都会带来差异。',
    sources: [gbStandard, cnisSurvey, mayoOffice],
  },
  sittingMonitorTop: {
    id: 'sittingMonitorTop',
    label: '坐姿屏幕顶部',
    summary: '根据坐姿眼高估算屏幕顶部的位置，并确保它不高于眼睛。',
    population: '中国 18–70 岁成人的人体尺寸，适用于单台常规显示器。',
    sourceCoverage: { minHeight: 143, maxHeight: 186 },
    adoptedData: '由椅面与坐姿眼高合成的身高/落地眼高节点（cm）：143/99、158/112、168.7/121、186/136；屏幕规则来自 OSHA 与 Mayo。',
    transformation: '将椅面中心值与坐姿眼高相加，再把屏幕顶部放在眼高以下 0–3 cm。',
    extrapolation: '身高超过 186 cm 后，每增加 1 cm，项目将落地眼高向上估算 0.78 cm。该结果来自项目估算。',
    limitations: '百分位配对不能代替个人回归。屏幕尺寸、后仰角度、坐垫压缩和渐进多焦点眼镜，都可能要求更低的屏幕位置。',
    sources: [gbStandard, oshaMonitor, mayoOffice],
  },
  standingMonitorTop: {
    id: 'standingMonitorTop',
    label: '站姿屏幕顶部',
    summary: '根据站姿眼高估算屏幕顶部的位置，并确保它不高于眼睛。',
    population: '中国 18–70 岁成人的人体尺寸，适用于单台常规显示器。',
    sourceCoverage: { minHeight: 143, maxHeight: 186 },
    adoptedData: '身高/立姿眼高节点（cm）：143/132、158/146、168.7/156.6、186/173；屏幕规则来自 OSHA 与 Mayo。',
    transformation: '按身高对站姿眼高做线性插值，再把屏幕顶部放在眼高以下 0–3 cm。',
    extrapolation: '身高超过 186 cm 后，每增加 1 cm，项目将眼高向上估算 0.93 cm。该结果来自项目估算。',
    limitations: '百分位配对不能代替个人回归。鞋底厚度、屏幕尺寸、站姿习惯和渐进多焦点眼镜，都会影响最后的屏幕位置。',
    sources: [gbStandard, oshaMonitor, mayoOffice],
  },
  distance: {
    id: 'distance',
    label: '观看距离',
    summary: '取多份专业指南的重叠区间作为观察起点，不把它当成精确目标。',
    population: '适用于普通电脑显示器，不依赖身高。',
    sourceCoverage: null,
    adoptedData: 'OSHA 建议通常为 50–100 cm；CCOHS 图示为 40–74 cm；Mayo 建议约一臂并给出 50–100 cm。',
    transformation: '取多份指南的重叠区间 50–75 cm，作为容易操作的起始观察范围。',
    extrapolation: '不按身高插值或外推。',
    limitations: '文字大小、视力、屏幕尺寸和工作内容都会影响观看距离。看不清时，可以先调大字号，避免身体前倾。',
